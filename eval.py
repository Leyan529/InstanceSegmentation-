...
if __name__ == '__main__':
    ...
    Image_dir     = "D:/WorkSpace/JupyterWorkSpace/DataSet/COCO/images/val2014"
    Json_path     = "D:/WorkSpace/JupyterWorkSpace/DataSet/COCO/annotations/instances_val2014.json"
    #-------------------------------------------------------#
    #   结果输出的文件夹，默认为map_out
    ...
    if map_mode == 0 or map_mode == 1:
        print("Load model.")
        yolact      = YOLACT(confidence = 0.05, nms_iou = 0.5, classes_path=classes_path)
