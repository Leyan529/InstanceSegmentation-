...
class COCODetection(data.Dataset):
    ...
    def pull_item(self, index):
        ...
        if len(target) > 0:
            ...
            obj_category_id = []
            label_map_obj_category_id = []
            label_map_obj_category_id_1 = []
            ...
            for obj in target:
                ...
                # obj_category_id.append(obj['category_id'])
                # label_map_obj_category_id.append(self.label_map[obj['category_id']])
                # label_map_obj_category_id_1.append(self.label_map[obj['category_id']] - 1)  
            ...
            # print("obj['category_id']: ", obj_category_id)
            # print("self.label_map[obj['category_id']]: ", label_map_obj_category_id)
            # print("self.label_map[obj['category_id']] - 1: ", label_map_obj_category_id_1)
            # print("------------------------------------------")
