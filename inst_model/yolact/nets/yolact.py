...
from inst_model.yolact.nets.resnet import ResNet
...
class FPN(nn.Module):
    ...
    def forward(self, backbone_features):
        ...
        # for p in self.lat_layers[0].parameters(): # 梯度爆炸
        #     print(p)           
        # print("----------------------------------")
...
class Yolact(nn.Module):
    def __init__(self, num_classes, coef_dim=32, pretrained=False, train_mode=True):
        ...
        if pretrained:
            self.backbone.load_state_dict(torch.load("model_data/weight/resnet50_backbone_weights.pth"))
