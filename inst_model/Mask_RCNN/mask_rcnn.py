...
from inst_model.Mask_RCNN.utils.utils_bbox import BBoxUtility
from inst_model.Mask_RCNN.utils.anchors import get_anchors
from inst_model.Mask_RCNN.utils.Evaluator import evaluate
...
class Mask_RCNN(object):
    ...
    def generate(self):
        ...
        self.net    = MaskRCNN(backbone, self.num_classes, use_pre_trained=False, train_mode=False)    
    ...
    def get_map_out(self, image):
        ...
        with torch.no_grad():
            ...
            boxes, labels, scores, masks_sigmoid = [x.cpu().numpy() for x in results]

        return boxes, scores, labels, None, masks_sigmoid
