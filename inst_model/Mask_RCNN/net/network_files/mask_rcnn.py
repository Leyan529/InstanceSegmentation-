...
class MaskRCNN(FasterRCNN):
    ...
    def __init__(
            ...
            mask_head=None,
            mask_predictor=None,
            use_pre_trained=False, train_mode=None
    ):
        ...
        if use_pre_trained:
            ...
            weights_dict = torch.load("model_data/weight/maskrcnn_resnet50_fpn_coco.pth", map_location="cpu")
            for k in list(weights_dict.keys()):
                if ("box_predictor" in k) or ("mask_fcn_logits" in k):
                    del weights_dict[k]

            print(self.load_state_dict(weights_dict, strict=False))
