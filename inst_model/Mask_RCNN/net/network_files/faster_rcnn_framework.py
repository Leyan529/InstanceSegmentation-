...
class FasterRCNNBase(nn.Module):
    ...
    def __init__(self, backbone, rpn, roi_heads, transform, train_mode):
    ...
    def forward(self, images, targets=None):
        ...
        """
        if self.train_mode and targets is None:
...
class FasterRCNN(FasterRCNNBase):
    ...
    def __init__(self, backbone, num_classes=None,
                 ...
                 bbox_reg_weights=None, train_mode=None):
        ...
        roi_heads = RoIHeads(
            ...
            bbox_reg_weights,
            box_score_thresh, box_nms_thresh, box_detections_per_img, train_mode=train_mode)  # 0.05  0.5  100
        ...
        transform = GeneralizedRCNNTransform(min_size, max_size, image_mean, image_std, train_mode=train_mode)

        super(FasterRCNN, self).__init__(backbone, rpn, roi_heads, transform, train_mode)
