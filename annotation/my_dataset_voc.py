...
class VOCInstances(Dataset):
    def __init__(self, voc_root, year="2012", txt_name: str = "train.txt", transforms=None, classes_path="voc_classes.txt"):
        super().__init__()
    ...
    def __getitem__(self, idx):
        ...
        if False:
            ...
            for i in range(len(target["labels"])):
                bbox        = target['boxes'][i]
                final_box   = [bbox[0], bbox[1], bbox[0] + bbox[2], bbox[1] + bbox[3], target['labels'][i] - 1]
...
if __name__ == '__main__':
    train_ds = VOCInstances(voc_root="/home/leyan/DataSet/VOCdevkit", year="2012", txt_name="train.txt")
    val_ds = VOCInstances(voc_root="/home/leyan/DataSet/VOCdevkit", year="2012", txt_name="val.txt")
    # print(len(dataset))
    # d1 = dataset[0]
