...
class MaskRCNN(nn.Module):
    ...
    def __init__(self, backbone, num_classes, predict,
                 # RPN parameters
        ...
        self.rpn = RegionProposalNetwork(
             ...
             rpn_reg_weights,
             rpn_pre_nms_top_n, rpn_post_nms_top_n, rpn_nms_thresh, predict)
        ...
        self.head = RoIHeads(
             ...
             box_reg_weights,
             box_score_thresh, box_nms_thresh, box_num_detections, predict)
...
def maskrcnn_resnet50(pretrained, num_classes, pretrained_backbone=True, predict = False):
    """
    ...
    model = MaskRCNN(backbone, num_classes, predict)
